<template>
  <div class="w-full p-5 rounded-xl bg-white flex flex-col gap-3">
    ...
    <div class="flex max-md:flex-col gap-3 w-full h-full">
      ...
      <BaseDropdownMenu :items="AttendanceOptions.map(statusAttendance => (
        {
          label: attendanceStatusLabels[statusAttendance], type: 'checkbox' as const, checked: selectedAttendance.includes(statusAttendance),
          onUpdateChecked(checked: boolean) {
            if (checked) {
  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4 w-full h-full">
    <div class="w-full p-4 bg-white rounded-lg flex flex-col gap-3 justify-center items-center">
      ...
      <div class="flex flex-col items-center gap-1">
        <span class="font-semibold text-2xl">{{ summaryData?.PRESENT ? summaryData?.PRESENT : 'وجود ندارد' }}</span>
    ...
    <div class="w-full p-4 bg-white rounded-lg flex flex-col gap-3 justify-center items-center">
      ...
      <div class="flex flex-col items-center gap-1">
        <span class="font-semibold text-2xl">{{ summaryData?.ABSENT ? summaryData?.ABSENT : 'وجود ندارد' }}</span>
    ...
    <div class="w-full p-4 bg-white rounded-lg flex flex-col gap-3 justify-center items-center">
      ...
      <div class="flex flex-col items-center gap-1">
        <span class="font-semibold text-2xl">{{ summaryData?.LATE ? summaryData?.LATE : 'وجود ندارد' }}</span>
    ...
    <div class="w-full p-4 bg-white rounded-lg flex flex-col gap-3 justify-center items-center">
      ...
      <div class="flex flex-col items-center gap-1">
        <span class="font-semibold text-2xl">{{ summaryData?.EXCUSED ? summaryData?.EXCUSED : 'وجود ندارد' }}</span>
    ...
    <div class="w-full p-4 bg-white rounded-lg flex flex-col gap-3 justify-center items-center">
      ...
      <div class="flex flex-col items-center gap-1">
        <span class="font-semibold text-2xl">{{ sessionsData?.totalSessions ? sessionsData?.totalSessions : 'وجود ندارد'
        }}</span>
...
import {
  AttendancePeriod, type AttendanceReport,
  type AttendanceSessions, type AttendanceSummary
