      ...
      <UForm :schema="schema" :state="state" @submit.prevent="onSubmit">
        <div class="flex flex-col gap-5 w-full">
          ...
          <div class="flex max-sm:flex-col items-center gap-5 sm:gap-2 w-full">
            ...
            <BaseFormInput required v-model="state.age" label="سن" name="age" type="text" placeholder="سن"
              class="w-full" />
          </div>
          <div class="flex max-sm:flex-col items-center gap-5 sm:gap-2 w-full">
          ...
          <div class="w-full">
            <BaseFormUploadFile :required="false" v-model="state.imageFile" label="ارسال عکس گواهینامه" name="imageFile"
