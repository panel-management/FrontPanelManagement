  ...
  <div v-if="formData" class="w-full p-5 flex flex-col items-center gap-6">
    ...
    <div class="relative size-52">
      <svg class="w-full h-full" viewBox="0 0 120 120">
        ...
        <circle class="stroke-info transition-all duration-500 ease-out" cx="60" cy="60" r="54" fill="none"
          stroke-width="12" pathLength="100" stroke-dasharray="100" :stroke-dashoffset="formData.progressPercentage"
