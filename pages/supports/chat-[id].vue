<template>
  <section class="h-dvh w-full rounded-sm p-4 bg-muted flex flex-col gap-4">
    ...
    <div class="bg-white h-full w-full rounded-xl p-4 flex flex-col gap-3 overflow-hidden">
      ...
      <div
        class="flex justify-center items-end pt-2"
        v-show="ticketData?.status !== TicketStatus.CLOSED"
      >
...
<script setup lang="ts">
  ...
  useHead({
    ...
    meta: [
      {
        name: 'description',
        content: 'مشاهده و مدیریت پیام‌ ها و تیکت‌ های کاربران در سیستم پشتیبانی',
      },
    ],
  })
</script>
