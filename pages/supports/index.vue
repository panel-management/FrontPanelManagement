  ...
  <section class="h-full w-full rounded-sm p-3 bg-muted flex flex-col gap-4">
    ...
    <div class="flex flex-col gap-3 p-4 bg-white rounded-lg">
      ...
      <div class="w-full h-full flex flex-col gap-3">
        <NuxtLink v-for="data in filterData" :key="data.id" :to="`/supports/chat-${data.id}`"
        ...
        <div v-if="!isLoading && filterData.length === 0"
    ...
    <div class="w-full flex bg-white p-4 rounded-lg justify-center items-center" v-if="totalPage > 1">
