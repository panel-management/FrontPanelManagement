  ...
  <section class="flex max-lg:flex-col justify-between w-full h-full lg:pt-3">
    <div class="w-full h-full p-4 rounded-lg shadow bg-black">
      <h2 class="font-bold text-white text-sm md:text-lg">
        حساب به نام {{ paymentName }} می باشد.
      </h2>
        ...
        <div class="flex flex-col gap-5 w-full">
          ...
          <div class="w-full flex flex-col gap-5">
            ...
            <BaseFormUploadFile
              ...
              label="ارسال  فیش واریزی"
              name="imageFile"
              description="اپلود عکس با فرمت (jepg, png, jpg) و حداکثر تا MB 1"
              class="w-full"
            />
          </div>
...
<script lang="ts" setup>
  ...
  const schema = v.object({
    bankName: v.pipe(v.string(), v.trim(), v.nonEmpty('نام بانک الزامی است')),
    ...
    imageFile: v.pipe(
      ...
      v.mimeType(
        ...
        'لطف عکس را با این فرمت ها اپلود کنید. (jpeg, png, jpg)'
      ),
  ...
  useHead({
    title: 'ثبت پرداخت',
    meta: [{ name: 'description', content: 'ارسال اطلاعات پرداخت و فیش واریزی.' }],
  })
</script>
